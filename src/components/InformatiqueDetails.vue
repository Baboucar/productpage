<template>
  <div>
    ...
    <section class="container">
      ...
      <div class="grid__info">
        ...
        <div class="info__details">
          <p>Vous vous trouvez face à un imprévu en termes de <router-link to="/photocopy">photocopies</router-link>, d'impression, de numérisation de documents : nous proposons à la location des équipements à usage bureautique dans un cadre professionnel. Nous sommes si réactifs que, selon votre localisation, vous pourrez utiliser le matériel à peine deux heures après votre commande.</p>
          ...
          <ul>
            <li
              class="info__list"
            >Ordinateurs  portables, <router-link to="/printers">imprimantes </router-link>, <router-link to="/photocopy">photocopies</router-link> ,<router-link to="/product"> scanners</router-link> et <router-link to="/product">accessoires</router-link></li>
    ...
    <div class="icons container">
      <a
        class="icons__link"
        href="https://www.linkedin.com/company/sogesmi-net/about/?viewAsMember=true"
      >
